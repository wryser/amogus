...
namespace amogus
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        void OnGameInitialized(object sender, EventArgs e)
        {
            ...
            Stream str = Assembly.GetExecutingAssembly().GetManifestResourceStream("amogus.Assets.amongus");
            AssetBundle bundle = AssetBundle.LoadFromStream(str);
            GameObject fumo = bundle.LoadAsset<GameObject>("amogus");
            realfumo = Instantiate(fumo);
            baka = bundle.LoadAsset<GameObject>("sus");
            baka.AddComponent<SusRemove>();
            ...
            realfumo.transform.localScale = new Vector3(1f, 1f, 1f);
            realfumo.transform.localRotation = Quaternion.Euler(0f, 335f, 90f);
            realfumo.transform.localPosition = new Vector3(-0.1f, 0.0f, -0.02f);
        }
